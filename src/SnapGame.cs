    ...
    public class SnapGame
    {
		...
		private static void HandleUserInput(Snap myGame)
		{
			...
			if (myGame.IsStarted) {
				if (SwinGame.KeyTyped (KeyCode.vk_LSHIFT) &&
					...
					SwinGame.LoadSoundEffectNamed ("Slap2", "hockey.wav");
					...
					myGame.PlayerHit (1);
					SwinGame.LoadSoundEffectNamed ("Slap1", "banana.wav");
		...
		private static void DrawGame(Snap myGame)
		{
			...
			if (top != null)
			{
				...
				SwinGame.DrawText ("Player 2 score: " + myGame.Score(1), Color.White,"GameFont", 0, 125);
